      ...
      <div className="px-2 sm:px-4 md:px-6">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <h1 className="text-sm sm:text-lg md:text-2xl font-bold text-blue-600 truncate">
              Village Khata Manager
            </h1>
          </div>

          {/* Right side - Settings dropdown */}
          <div className="flex items-center gap-1 sm:gap-4 flex-shrink-0 relative" ref={settingsRef}>
            {/* Settings Dropdown */}
            <div className="relative">
              ...
              {/* Dropdown Menu */}
              {settingsOpen && (
                <div className="absolute right-0 mt-2 w-48 sm:w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-50 py-2">
